...
/**
 * Class which describes a piece of property in Calgary, for use in multiple
 * city applications.
 **/
abstract class CalgaryProperty {
    ...
    /** Constructors **/
    public CalgaryProperty(int taxRollNumber, String zoning, String streetName, int buildingNumber, String postCode,
    ...
    /** Helpers **/
    private void createProperty(String zoning, String streetName, int buildingNumber, String postCode)
            throws IllegalArgumentException {
